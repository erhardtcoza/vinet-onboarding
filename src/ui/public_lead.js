...
<style>
/* identical to the form I sent earlier (mobile-first + sticky submit) */
:root{--brand:#e2001a; --ink:#111; --muted:#6b7280; --line:#e6e7eb; --bg:#f7f7fa; --ok:#0a7d2b; --card:#fff}
...
input,select,textarea{width:100%;padding:14px;border:1px solid #d7d9de;border-radius:12px;background:#fff;font-size:16px}
...
.btn{display:inline-flex;align-items:center;justify-content:center;gap:.5rem;background:var(--brand);color:#fff;border:none;border-radius:14px;padding:14px 16px;font-weight:800;cursor:pointer;width:100%;font-size:1rem}
.actions{margin-top:16px}
.toast{position:fixed;left:16px;right:16px;bottom:16px;background:#fff;border:1px solid var(--line);border-radius:12px;padding:16px;box-shadow:0 12px 36px rgba(0,0,0,.16);display:none;z-index:20}
...
<div class="wrap"><div class="card">
  <div class="header">
    <div class="logo-box"><img src="https://static.vinet.co.za/Vinet%20Logo%20Png_Full%20Logo.png" alt="Vinet"/></div>
    <div><h1>New Service Enquiry</h1><div class="sub">Tell us where you need internet</div></div>
  </div>
